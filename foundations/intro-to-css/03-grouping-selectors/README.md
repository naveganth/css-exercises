...
Yes, both buttons have their correspondent class.
- Did you use the grouping selector for styles that both elements share?
Yes, grouped them together by adding a comma between both class names.
- Did you make separate rules for the styles unique to each element?
Yes, both buttons have rules related to them.
